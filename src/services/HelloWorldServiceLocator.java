...
public class HelloWorldServiceLocator extends org.apache.axis.client.Service implements services.HelloWorldService {
    ...
    public services.HelloWorld_PortType getHelloWorld(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            services.HelloWorldSoapBindingStub _stub = new services.HelloWorldSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (services.HelloWorld_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                services.HelloWorldSoapBindingStub _stub = new services.HelloWorldSoapBindingStub(new java.net.URL(HelloWorld_address), this);
                _stub.setPortName(getHelloWorldWSDDServiceName());
                return _stub;
            }
